...
from math import exp, fsum, cos, pi
...
class DistanceDict(dict):
    ...
    def __setitem__(self, key, value):
        raise NotImplementedError("Defining items is not supported in DistanceDict.")
...
class CustomEfficientNetV2(nn.Module):
    """CustomEfficientNetV2 model with modified head using EfficientNetV2 backbone.
    ...
    def __init__(self, num_classes, input_size=(384, 384)):
        ...
        """
        super().__init__()
        # Creates the backbone model with head removed.
...
def init_model_on_hpu():
    """
    Inicializa o modelo CustomEfficientNetV2 no dispositivo HPU disponível.
    """
    print("=> Usando EfficientNetV2 com cabeçalho customizado")
...
def _load_checkpoint(model, optimizer, scheduler):
    ...
    if os.path.isfile(checkpoint_path):
        ...
        # Apply checkpoint unfreezing policies
        ...
        if "optimizer" in checkpoint:
            try:
                ...
                print("Could not load optimizer, initializing from scratch.")
...
def load_data(train_csv, val_csv, distributed):
    """
    Loads training and validation data with transformations for 256x256.
    """
...
# =============================================================================
# MAIN WORKER (TRAINING/VALIDATION)
# =============================================================================
def main_worker():
    """
    ...
    loss_function = nn.CrossEntropyLoss().to("hpu")
    ...
    for epoch in range(start_epoch, 100):  # Single epoch loop
        ...
        summary_train, steps, _ = run(
             train_loader, model, loss_function, distances, None, classes, 
    ...
    while retry_count < max_retries:
        try:
            ...
            if "UR_RESULT_ERROR_OUT_OF_RESOURCES" in str(e):
                ...
                break  # Exit loop on different error
    else:
        print("[FATAL] Maximum attempts exceeded. Ending execution.")
