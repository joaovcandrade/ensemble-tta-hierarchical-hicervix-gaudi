...
class CustomCaFormer(nn.Module):
    ...
    Uses the pre-trained 'caformer_m36.sail_in22k_ft_in1k_384' model from timm with the head removed.
...
def init_model_on_hpu():
    """
    Inicializa o modelo CustomCaFormer no dispositivo HPU disponível.
    """
    print("=> Usando CaFormer com cabeçalho customizado")
